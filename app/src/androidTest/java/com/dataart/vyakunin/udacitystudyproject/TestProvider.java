...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        Uri returnUri = getContext().getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);
        long locationRowId = returnUri != null ? ContentUris.parseId(returnUri) : -1;
