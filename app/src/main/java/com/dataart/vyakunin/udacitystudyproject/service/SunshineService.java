package com.dataart.vyakunin.udacitystudyproject.service;
...
public class SunshineService extends IntentService {
    ...
    public static final String LOCATION_QUERY_PARAM = "lqe";
    ...
    protected void onHandleIntent(Intent intent) {
        String locationQuery = intent.getStringExtra(LOCATION_QUERY_PARAM);
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            ...
            locationValues.put(WeatherContract.LocationEntry.COLUMN_LOCATION_LAT, lat);
            locationValues.put(WeatherContract.LocationEntry.COLUMN_LOCATION_LONG, lon);
