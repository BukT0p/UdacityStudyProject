...
import com.dataart.vyakunin.udacitystudyproject.HomeActivity;
import com.dataart.vyakunin.udacitystudyproject.R;
import com.dataart.vyakunin.udacitystudyproject.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationValues.put(LocationEntry.COLUMN_LOCATION_NAME, cityName);
    ...
    private void notifyWeather() {
        ...
        boolean syncEnabled = prefs.getBoolean(context.getString(R.string.pref_sync), true);
        if (!syncEnabled)
            return;
